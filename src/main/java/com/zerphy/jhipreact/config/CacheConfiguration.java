package com.zerphy.jhipreact.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(com.zerphy.jhipreact.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(com.zerphy.jhipreact.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
